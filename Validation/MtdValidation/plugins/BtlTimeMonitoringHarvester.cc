...
std::tuple<double, double, double> BtlTimeMonitoringHarvester::computeMedianErrorBootstrap(MonitorElement* me, unsigned int nResamples) const {
    ...
    const double threshold = 0.88 * totalCounts;//prima 0.83
    int cumulative = 0;
    int cutoffBin = nbins;
...
std::tuple<double, double, double> BtlTimeMonitoringHarvester::computeMean_MeanError(MonitorElement* me) const {
    ...
    const double threshold = 0.88 * totalCounts;
    int cumulative = 0;
    int cutoffBin = nbins;
...
std::vector<double> RU_phi_meanOfMedians;//Media delle singole mediane per RU slice
std::vector<double> RU_phi_meanOfMedianUncertainties;//Errore delle media di RU_phi_meanOfMedians
std::vector<double> RU_phi_meanOfMedianErrors;//Media dei singoli errori delle mediane per RU slice
std::vector<double> RU_phi_meanOfMedianErrorsUncertainties; //Errore delle media di RU_phi_meanOfMedianErrorsUncertainties
...
//-----------------------------------------
    ...
    << std::setw(10) << "nTray"
    << std::setw(15) << "Median"
    << std::setw(15) << "Er Median"
    << std::setw(15) << "Unc Er-Median"
    << std::setw(15) << "Mean"
    << std::setw(15) << "Er Mean"
    ...
    for (unsigned int t = 0; t < nTray; ++t) {
	    ...
	    << std::setw(15) << medians[t]
            << std::setw(15) << medianErrors[t]
            << std::setw(15) << medianErrorUncertainties[t]
	    << std::setw(15) << RuMeans[t]
	    << std::setw(15) << RuMeanErrors[t]
	    << std::setw(15) << RuMeanErrorsUncertainties[t]
            << "\n";
    }
    out_RU_Slice_Tray << "-----------------------------------------------------------------------";
...
for (unsigned int ru = 0; ru < nRU; ++ru) {
        out_RU_Slice_Mean << std::setw(10) << ru + 1
            ...
            << std::setw(15) << RU_phi_meanOfMedianUncertainties[ru]	    
            << std::setw(15) << RU_phi_meanOfMedianErrors[ru]
            << std::setw(15) << RU_phi_meanOfMedianErrorsUncertainties[ru]
...
for (unsigned int i = 1; i <= nSM; ++i) {
  ...
  SMmeanErrorUncertainties.push_back(meanErrorUncertainty);
...
for (unsigned int i = 0; i < nSM; ++i) {
    out_SMslice << std::setw(10) << i+1
	        << std::setw(15) << SMmedians[i]
                << std::setw(15) << SMmedianErrors[i]
                << std::setw(15) << SMmedianErrorUncertainties[i]
